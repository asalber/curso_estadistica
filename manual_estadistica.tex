...
% !TEX program = xelatex
% ASPECT RATIO FOR YOUTUBE VIDEO%\documentclass[aspectratio=169,profesionalfont,10pt,svgnames,xcolor=table]{beamer}
...
% \include{capitulos/descriptiva}
% \include{capitulos/regresion}
% \include{capitulos/probabilidad}
