...
Como sabéis, una fotografía digital está formada por multitud de pequeños puntitos llamados pixels que se dispone
...
\cline{2-5}
\multicolumn{1}{c|}{Nombre} & \multicolumn{1}{c|}{Edad (años)} & \multicolumn{1}{c|}{Sexo} & \multicolumn{1}{c|}{Peso (Kg)} &
