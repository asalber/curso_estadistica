...
\lhead{\textsc{\textcolor[rgb]{0.00,0.00,0.50}{\color{blueceu}Universidad CEU San Pablo}}}
\rhead{\textsl{\textsf{\textcolor[rgb]{0.00,0.00,0.50}{\color{blueceu}Departamento de Matemática Aplicada y Estadística}}}}
\renewcommand{\headrulewidth}{0pt}

\begin{document}

\section*{\color{blueceu}Intervalos de Confianza}
\begin{center}
