...
{\bfseries Distribución mesocúrtica $g_2=0$};

\node[text=drawColor,rotate= 90.00,anchor=base,inner sep=0pt, outer sep=0pt, scale=  1.00] at ( 10.80,186.67) {Frecuencia relativa};
\end{scope}
\begin{scope}
