...
\node (sample) at (0,8) {\includegraphics[height=4cm]{img/descriptiva/muestra.png}}; 
\pause
\node (ordered-sample) at (0,0) {\includegraphics[height=4cm]{img/descriptiva/muestra_ordenada.png}};
