...
tikz(file="img/variables_aleatorias_continuas/funcion_distribucion_normal_estandar.tex", width=4, height=4)
par(mar=c(3.5,3.5,3,1), mgp=c(2.2,0.6,0), las=1)
x = seq(-3.32, 3.32, by=0.04)
y = dnorm(x,mean=0,sd=1)
x0 = x[97]
p0 = floor(pnorm(x0, mean=0, sd=1, lower.tail=TRUE)*10000)/10000
plot(x, y, ylim=c(0,0.45), xlab="$Z$", ylab="Densidad de probabilidad $f(z)$", main="Distribución Normal Estándar $N(0,1)$", type="n", yaxs="i")
