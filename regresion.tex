...
\frametitle{Diagrama de dispersión}
\begin{center}
\scalebox{0.8}{\input{img/regresion/diagrama_dispersion_estatura_peso}}
\end{center}
...
\scalebox{0.35}{
\begin{tabular}{ccc}
\input{img/regresion/diagrama_dispersion_sin_relacion} &
\input{img/regresion/diagrama_dispersion_relacion_lineal} &
\input{img/regresion/diagrama_dispersion_relacion_parabolica}\\
\input{img/regresion/diagrama_dispersion_relacion_exponencial} &
\input{img/regresion/diagrama_dispersion_relacion_logaritmica} &
\input{img/regresion/diagrama_dispersion_relacion_inversa}
\end{tabular}
}
\end{center}
...
\begin{center}
\scalebox{0.8}{\input{img/regresion/desviaciones}}
\end{center}
