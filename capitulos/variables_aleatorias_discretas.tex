...
\begin{center}
  ...
  \mode<presentation>{\resizebox{0.45\textwidth}{!}{\input{img/variables_aleatorias_discretas/funcion_probabilidad_uniforme_discreta}}}
\end{center}
...
\begin{center}
  ...
  \mode<presentation>{\resizebox{0.45\textwidth}{!}{\input{img/variables_aleatorias_discretas/funcion_probabilidad_binomial}}}
\end{center}
...
\begin{center}
  ...
  \mode<article>{\resizebox{0.7\textwidth}{!}{\input{img/variables_aleatorias_discretas/espacio_probabilistico_binomial}}}
  \mode<presentation>{\resizebox{0.55\textwidth}{!}{\input{img/variables_aleatorias_discretas/espacio_probabilistico_binomial}}}
\end{center}
...
\begin{center}
  ...
  \mode<presentation>{\resizebox{0.42\textwidth}{!}{\input{img/variables_aleatorias_discretas/funcion_probabilidad_poisson}}}
  \end{center}
