...
\resizebox{0.4\textwidth}{!}{\input{img/regresion/diagrama_dispersion}}
\end{center}
...
\mode<article>{\resizebox{0.7\textwidth}{!}{\input{img/regresion/diagrama_dispersion_estatura_peso}}}
\mode<presentation>{\resizebox{0.9\textwidth}{!}{\input{img/regresion/diagrama_dispersion_estatura_peso}}}
\end{center}
...
\resizebox{\textwidth}{!}{\input{img/regresion/diagrama_dispersion_tipos_relaciones}}
...
\mode<article>{\resizebox{0.7\textwidth}{!}{\input{img/regresion/desviaciones_medias}}}
\mode<presentation>{\resizebox{0.8\textwidth}{!}{\input{img/regresion/desviaciones_medias}}}
\end{center}
...
\resizebox{0.4\textwidth}{!}{\input{img/regresion/cuadrantes_diagrama_dispersion}}
\end{center}
...
\mode<article>{\resizebox{0.6\textwidth}{!}{\input{img/regresion/diagrama_dispersion_lineal_creciente}}}
\mode<presentation>{\resizebox{0.9\textwidth}{!}{\input{img/regresion/diagrama_dispersion_lineal_creciente}}}
...
\mode<article>{\resizebox{0.6\textwidth}{!}{\input{img/regresion/diagrama_dispersion_lineal_decreciente}}}
\mode<presentation>{\resizebox{0.9\textwidth}{!}{\input{img/regresion/diagrama_dispersion_lineal_decreciente}}}
...
\mode<article>{\resizebox{0.7\textwidth}{!}{\input{img/regresion/residuos_y}}}
\mode<presentation>{\resizebox{0.9\textwidth}{!}{\input{img/regresion/residuos_y}}}
...
\mode<article>{\resizebox{0.7\textwidth}{!}{\input{img/regresion/rectas_regresion}}}
\mode<presentation>{\resizebox{0.9\textwidth}{!}{\input{img/regresion/rectas_regresion}}}
\end{center}
...
\mode<article>{\resizebox{0.6\textwidth}{!}{\input{img/regresion/regresion_lineal_perfecta}}}
\mode<presentation>{\resizebox{0.9\textwidth}{!}{\input{img/regresion/regresion_lineal_perfecta}}}
\end{center}
\end{column}
\begin{column}{0.48\textwidth}
...
\mode<article>{\resizebox{0.6\textwidth}{!}{\input{img/regresion/rectas_independencia_lineal}}}
\mode<presentation>{\resizebox{0.9\textwidth}{!}{\input{img/regresion/rectas_independencia_lineal}}}
\end{center}
\end{column}
\end{columns}
...
\input{img/regresion/interpretacion_pendiente}
\end{center}
...
\mode<article>{\resizebox{0.7\textwidth}{!}{\input{img/regresion/descomposicion_variabilidad}}}
\mode<presentation>{\resizebox{0.9\textwidth}{!}{\input{img/regresion/descomposicion_variabilidad}}}
\end{center}
...
\resizebox{\textwidth}{!}{\input{img/regresion/grados_correlacion}}
\end{frame}
...
\mode<article>{\resizebox{0.7\textwidth}{!}{\input{img/regresion/evolucion_bacterias}}}
\mode<presentation>{\resizebox{0.9\textwidth}{!}{\input{img/regresion/evolucion_bacterias}}}
\end{center}
\end{column}
\end{columns}
...
\mode<article>{\resizebox{0.7\textwidth}{!}{\input{img/regresion/regresion_lineal_bacterias}}}
\mode<presentation>{\resizebox{0.9\textwidth}{!}{\input{img/regresion/regresion_lineal_bacterias}}}
\end{center}
\end{column}
\end{columns}
\begin{center}
...
\mode<article>{\resizebox{0.7\textwidth}{!}{\input{img/regresion/evolucion_log_bacterias}}}
\mode<presentation>{\resizebox{0.9\textwidth}{!}{\input{img/regresion/evolucion_log_bacterias}}}
\end{center}
\end{column}
\end{columns}
...
\mode<article>{\resizebox{0.7\textwidth}{!}{\input{img/regresion/regresion_exponencial_bacterias}}}
\mode<presentation>{\resizebox{0.9\textwidth}{!}{\input{img/regresion/regresion_exponencial_bacterias}}}
\end{center}
\end{column}
\end{columns}
...
\resizebox{0.49\textwidth}{!}{\input{img/regresion/regresion_lineal_relacion_cuadratica}}
\tikzsetnextfilename{regresion/regresion_cuadratica}
\resizebox{0.49\textwidth}{!}{\input{img/regresion/regresion_cuadratica}}
\end{center}
...
\resizebox{0.7\textwidth}{!}{\input{img/regresion/diagrama_dispersion_con_datos_atipicos}}
\end{center}
...
\resizebox{0.49\textwidth}{!}{\input{img/regresion/regresion_lineal_con_datos_atipicos}}
\tikzsetnextfilename{regresion/regresion_lineal_sin_datos_atipicos}
\resizebox{0.49\textwidth}{!}{\input{img/regresion/regresion_lineal_sin_datos_atipicos}}
\end{center}
...
\begin{frame}
  ...
  \resizebox{0.7\textwidth}{!}{\input{img/regresion/paradoja_simpson_1}}
  \end{center}
  \mode<article>{
  \begin{center}
  \tikzsetnextfilename{regresion/paradoja_simpson_2}
  \resizebox{0.7\textwidth}{!}{\input{img/regresion/paradoja_simpson_2}}
  \end{center}
  }
  \end{frame}
