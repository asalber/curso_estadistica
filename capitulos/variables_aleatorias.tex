...
\begin{center}
	...
	\mode<article>{\resizebox{0.6\textwidth}{!}{\input{img/variables_aleatorias_discretas/espacio_probabilistico_dos_monedas}}}
	\mode<presentation>{\resizebox{0.6\textwidth}{!}{\input{img/variables_aleatorias_discretas/espacio_probabilistico_dos_monedas}}}
\end{center}
...
\begin{center}
	...
	\tikzsetnextfilename{discrete_random_variables/funcion_probabilidad_dos_monedas}
	\mode<article>{\resizebox{0.45\textwidth}{!}{\input{img/discrete_random_variables/funcion_probabilidad_dos_monedas}}}
	\mode<presentation>{\resizebox{0.45\textwidth}{!}{\input{img/discrete_random_variables/funcion_probabilidad_dos_monedas}}}
	&
	\tikzsetnextfilename{discrete_random_variables/funcion_distribucion_dos_monedas}
	\mode<article>{\resizebox{0.45\textwidth}{!}{\input{img/discrete_random_variables/funcion_distribucion_dos_monedas}}}
	\mode<presentation>{\resizebox{0.45\textwidth}{!}{\input{img/discrete_random_variables/funcion_distribucion_dos_monedas}}}
	\end{tabular}
\end{center} 
...
Al igual que para describir las variables medidas en las muestras se utilizan estadísticos descriptivos muestrales, para describir determinadas características de las variables aleatorias se utilizan también estadísticos poblacionales.
