...
\begin{center}
\input{img/estimacion/obtencion_muestra}
\end{center}
\end{frame}
...
\resizebox{0.9\textwidth}{!}{\input{img/estimacion/teorema_central_limite}}
\end{center}
\end{column}
\end{columns}
\end{frame}
...
\input{img/estimacion/estimador_estimacion}
\end{center}
\end{frame}
...
\scalebox{0.7}{\input{img/estimacion/estimadores_sesgados_insesgados}}
\end{center}
\end{frame}
...
\resizebox{0.49\textwidth}{!}{\input{img/estimacion/estimadores_consistentes}}
\tikzsetnextfilename{estimacion/estimadores_consistentes_sesgados}
\resizebox{0.49\textwidth}{!}{\input{img/estimacion/estimadores_consistentes_sesgados}}
\end{center}
\end{frame}
...
\scalebox{0.7}{\input{img/estimacion/estimador_eficiente_sesgado}}
\end{center}
\end{frame}
...
\scalebox{0.7}{\input{img/estimacion/estimador_asintoticamente_normal}}
\end{center}
...
\begin{center}
\scalebox{0.9}{\input{img/estimacion/100_intervalos_confianza}}
\end{center}
\end{frame}
...
\scalebox{0.65}{\input{img/estimacion/extremos_intervalos}}
\end{center}
\end{frame}
...
\scalebox{0.8}{\input{img/estimacion/extremos_intervalo_media_normal}}
\end{center}
\end{frame}
...
\scalebox{0.8}{\input{img/estimacion/extremos_intervalo_varianza_normal}}
\end{center}
\end{frame}
